  ...
  return (
    <main>
      ...
      <section className="hero" id="vision">
        <div className="hero-grid grid-shell">
          <div className="hero-copy">
            ...
            <h1>Architecting a <em>reusable</em> reusable Q-Data pipeline for quantum-ready cybersecurity datasets..</h1>
      ...
      <section className="evidence-section section" id="evidence">
        <div className="grid-shell">
          <div className="section-heading split-heading light-heading"><div><p className="section-number">06 · Evidence and evaluation</p><h2>The planning project will establish rigorous, reproducible comparisons between classical and quantum approaches.</h2></div><p>Every success criterion is tied to observable evidence. Technical failures, negative results, disagreement, and subgroup losses are retained because they determine whether scale-up is justified.</p></div>
